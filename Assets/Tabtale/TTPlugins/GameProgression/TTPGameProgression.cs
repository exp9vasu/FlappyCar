...
namespace Tabtale.TTPlugins
{
    ...
    public class TTPGameProgression
    {
        ...
        public class FirebaseEvents
        {
            ...
            internal static void LevelUp(int buildIndex)
            {
                throw new NotImplementedException();
            }

            internal static void MissionStarted(int missionID)
            {
                throw new NotImplementedException();
            }

            internal static void MissionFailed()
            {
                throw new NotImplementedException();
            }

            internal static void MissionComplete()
            {
                throw new NotImplementedException();
            }

            internal static void MissionCompleted()
            {
                throw new NotImplementedException();
            }
        }
